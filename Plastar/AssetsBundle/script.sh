...
CREATION_TIME="$1" ASSET_BUNDLE_PROJECT_DIR=/c/TangoProject/sample/recognize/backEnd/Plastar/Plastar/AssetsBundle/tmp/assetbundler
...
echo "Rename Bundle"; cd ${ASSET_BUNDLE_DIR}/${CREATION_TIME}; mv marker marker.jpg;
